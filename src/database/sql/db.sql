...
CREATE TABLE
    `Credit` (
        ...
        INDEX IDX_CREDIT_ORIGINAL_FULLNAME (originalFullName)
    ) AUTO_INCREMENT = 1000;
...
CREATE TABLE
    `Category` (
        ...
        INDEX IDX_CATEGORY_TRANSLATION_KEY (translationKey)
    ) AUTO_INCREMENT = 600;
...
CREATE TABLE
    `Selection` (
        ...
        isOrderRandom BOOLEAN DEFAULT 0,  
        createdAt DATETIME (3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
        updatedAt DATETIME (3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
        CONSTRAINT SELECTION_PK PRIMARY KEY (id),
        INDEX IDX_SELECTION_NAME (name)
...
CREATE TABLE
    `License` (
        ...
        srcLogo INT NULL,
        srcBackground INT NULL,
        isSelectionOrderRandom BOOLEAN DEFAULT 0,
        isMediaOrderRandom BOOLEAN DEFAULT 0,
        createdAt DATETIME (3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
        updatedAt DATETIME (3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
...
CREATE TABLE
    `Media_Library` (
        ...
        CONSTRAINT MEDIA_LIBRARY_PATH_TYPE UNIQUE (path, libraryId, type),
