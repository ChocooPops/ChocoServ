...
CREATE TABLE
    `Staff` (
        ...
        INDEX IDX_STAFF_SRCPOSTER (srcPoster),
    );
...
-- MEDIA STAFF
ALTER TABLE `Staff` ADD CONSTRAINT FK_STAFF_Poster FOREIGN KEY (srcPoster) REFERENCES `Poster` (id) ON DELETE SET NULL ON UPDATE CASCADE;
